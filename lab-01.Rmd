...
Because the code is including NA values in the calculation for the mean.
...
Done above. Added the na.rm = TRUE to the mean and median functions.
...
visitors_with_nations %/%
  mutate(proportion_free = count(admission == Free) / count()) %/%
